...
output "launch_template_id" {
  ...
  value       = try(aws_launch_template.was[0].id, null)
}

output "launch_template_arn" {
  description = "The ARN of the launch template"
  value       = try(aws_launch_template.was[0].arn, null)
}

output "launch_template_name" {
  description = "The name of the launch template"
  value       = try(aws_launch_template.was[0].name, null)
}

output "launch_template_default_version" {
  description = "The default version of the launch template"
  value       = try(aws_launch_template.was[0].default_version, null)
}
...
output "security_group_arn" {
  ...
  value       = try(aws_security_group.was[0].arn, "")
}
...
output "security_group_vpc_id" {
  ...
  value       = try(aws_security_group.was[0].vpc_id, "")
}

output "security_group_owner_id" {
  description = "The owner ID"
  value       = try(aws_security_group.was[0].owner_id, "")
}

output "security_group_name" {
  description = "The name of the security group"
  value       = try(aws_security_group.was[0].name, "")
}

output "security_group_description" {
  description = "The description of the security group"
  value       = try(aws_security_group.was[0].description, "")
}